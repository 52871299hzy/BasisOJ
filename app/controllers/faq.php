...
<article>
	...
	<section>
		...
		<div id="collapseThree" class="collapse">
			...
			<p>C++的编译器是 g++ 7.3.0，编译命令：<code>g++ code.cpp -o code -lm -O2 -DONLINE_JUDGE</code>。如果选择C++11会在编译命令后面添加<code>-std=c++11</code>。</p>
			<p>C的编译器是 gcc 7.3.0，编译命令：<code>gcc code.c -o code -lm -O2 -DONLINE_JUDGE</code>。</p>
			<p>Pascal的编译器是 fpc 3.0.4，编译命令：<code>fpc code.pas -O2</code>。</p>
			<p>Java7的JDK版本是 jdk-7u80，编译命令：<code>javac code.java</code>。</p>
			<p>Java8的JDK版本是 jdk-8u181，编译命令：<code>javac code.java</code>。</p>
